...
const GoldHunters = () => {
  ...
  const handleSaveFullName = async () => {
    ...
    if (id) {
      try {
        // Calculate newBalance here instead of receiving as parameter
                  ...
                  <h1 className="flex w-full justify-center items-center space-x-1 pb-2">
                    ...
                    <span className="text-[#fff] text-[32px] font-bold">
                      <span className="pl-[2px]">
                        ...
                        <span className="text-btn4">MAX</span>
                      </span>
                    </span>
                  </h1>
                  <div></div>
                      ...
                      {energy === 0 && points === 0 ? (
                        ...
                        <>
                          <span className="text-[#fff] font-semibold text-[24px]">
                            <span className="pl-[2px]">
                              {points} <span className="text-btn4">MAX</span>
                            </span>
                          </span>
                          <button
                            onClick={handleClaim}
